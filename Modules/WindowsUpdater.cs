...
namespace WindowsHealth_ServerCheck.Modules
{
    public class WindowsUpdater
    {
        ...
        /// false → solo busca y lista las actualizaciones disponibles, no descarga ni instala.
        /// true  → busca, descarga e instala (comportamiento original).
        /// </param>
            ...
            bool installUpdates = false)
        {
            ...
            try
            {
                ...
                ISearchResult searchResult = updateSearcher.Search("IsInstalled=0 and DeploymentAction=*");
                ...
                // Modo solo consulta: termina aquí sin descargar ni instalar
                if (!installUpdates)
                {
                ...
                // Modo instalación: descarga e instala
